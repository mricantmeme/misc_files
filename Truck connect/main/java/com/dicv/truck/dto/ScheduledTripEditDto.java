...
/**
 * This class is responsible to get edit route plan fields details.
 * 
 * @author aut7kor
 * 
 */
public class ScheduledTripEditDto {
	...
	public String toString() {
		return "ScheduledTripEditDto [userId=" + userId + ", scheduledTripId="
				+ scheduledTripId + ", vehicleId=" + vehicleId + ", driverId="
